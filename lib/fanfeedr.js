...
//object with available resources in the API
fanfeedr.resources={
...
fanfeedr.getSportSources=function(sportId,callback){
     jsonRequest(this.resources.sport.newChildResource(sportId)+this.resources.source.path(),callback);
};
...
fanfeedr.getLeagueSources=function(leagueId,callback){
     jsonRequest(this.resources.league.newChildResource(leagueId)+this.resources.source.path(),callback);
};
...
fanfeedr.getLeagueSources=function(conferenceId,callback){
     jsonRequest(this.resources.conference.newChildResource(conferenceId)+this.resources.source.path(),callback);
};
...
fanfeedr.getLeagueSources=function(teamId,callback){
     jsonRequest(this.resources.team.newChildResource(teamId)+this.resources.source.path(),callback);
};
...
fanfeedr.getLeagueSources=function(personId,callback){
     jsonRequest(this.resources.person.newChildResource(personId)+this.resources.source.path(),callback);
};
...
fanfeedr.getSource=function(sourceId,callback){
     jsonRequest(this.resources.source.newChildResource(sourceId),callback);
};
//TRENDING
...
fanfeedr.getSportTrendingTeams=function(sportId,callback){
     jsonRequest(this.resources.sport.newChildResource(sportId)+this.resources.trending.path(),callback);
};
...
fanfeedr.getLeagueTrendingTeams=function(leagueId,callback){
     jsonRequest(this.resources.league.newChildResource(leagueId)+this.resources.trending.path(),callback);
};
...
fanfeedr.getDivisionTrendingTeams=function(divisionId,callback){
     jsonRequest(this.resources.division.newChildResource(divisionId)+this.resources.trending.path(),callback);
};
...
fanfeedr.getSportTrendingPersons=function(sportId,callback){
     jsonRequest(this.resources.sport.newChildResource(sportId)+this.resources.trending.path()+this.resources.person.path(),callback);
};
...
fanfeedr.getLeagueTrendingPersons=function(leagueId,callback){
     jsonRequest(this.resources.league.newChildResource(leagueId)+this.resources.trending.path()+this.resources.person.path(),callback);
};
...
fanfeedr.getDivisionTrendingPersons=function(divisionId,callback){
     jsonRequest(this.resources.division.newChildResource(divisionId)+this.resources.trending.path()+this.resources.person.path(),callback);
};
...
fanfeedr.getTeamTrendingPersons=function(teamId,callback){
     jsonRequest(this.resources.team.newChildResource(teamId)+this.resources.trending.path()+this.resources.person.path(),callback);
};
